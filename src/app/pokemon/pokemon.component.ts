...
@Component({
  ...
  template: `
    <div>
      <a
        [routerLink]="['/homme']" routerLinkActive="router-link-active"
      ...
      <div class="p-2  mt-5 border-2 border-r-blue-500 border-t-green-500 border-l-red-500 border-b-yellow-500">
